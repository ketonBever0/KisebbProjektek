...
export class AuthController {
  ...
  async getOneUser(@Param("id") id: string) {
    return await this.authService.getOneUser(parseInt(id));
  }

  @Delete("/user/:id")
  @UseGuards(AuthGuard, RoleGuard)
  @Roles("ADMIN")
  async deleteUserForever(@Param("id") id: string) {
    return await this.authService.deleteUserForever(parseInt(id));
  }
}
