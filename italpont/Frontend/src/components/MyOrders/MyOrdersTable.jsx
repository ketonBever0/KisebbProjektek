...
export default function EnhancedTable(props) {
  ...
  const rows = [
    ...
    createData(3, "2024.01.05", "3300", "Eger", "Dobó tér 5", "89000"),
    createData(4, "2024.01.07", "9027", "Győr", "Fehérvári út 45", "145000"),
    createData(5, "2024.01.10", "4032", "Debrecen", "Egyetem tér 1", "178000"),
    createData(6, "2024.01.12", "7634", "Pécs", "Hársfa utca 18", "134000"),
  ];
