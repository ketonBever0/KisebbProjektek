...
function Menu() {
    return (
        <div>
            <header aria-label="Site Header" className="bg-secondary">
                        ...
                        <div className="hidden md:block">
                            <nav aria-label="Site Nav">
                                <ul className="flex items-center gap-6 text-sm">
                                    <li>
                                        <Link to={'/'} className="text-white transition hover:text-gray-500/75">Home</Link>
                                    </li>
                                    <li>
                                        <Link to={'/store'} className="text-white transition hover:text-gray-500/75">Store</Link>
                                    </li>
                                </ul>
                            </nav>
                        </div>
